...
var format_Borough_5 = new ol.format.GeoJSON();
var features_Borough_5 = format_Borough_5.readFeatures(json_Borough_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Borough_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Borough_5.addFeatures(features_Borough_5);
var lyr_Borough_5 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Borough_5, 
                style: style_Borough_5,
                interactive: true,
                title: '<img src="styles/legend/Borough_5.png" /> Borough'
            });
...
lyr_GoogleRoad_0.setVisible(true);lyr_Designated_Open_Space_1.setVisible(true);lyr_Conservation_Areas_2.setVisible(true);lyr_Areas_of_Intensification_3.setVisible(true);lyr_Opportunity_Areas1Opportunity_AreasMultiPolygon_4.setVisible(true);lyr_Borough_5.setVisible(true);
var layersList = [group_NATUREANDENVIRONMENT,group_TRANSFORMATIONAREAS,lyr_Borough_5];
...
lyr_Borough_5.set('fieldAliases', {'NAME': 'NAME', 'AREA_CODE': 'AREA_CODE', 'DESCRIPTIO': 'DESCRIPTIO', 'FILE_NAME': 'FILE_NAME', 'NUMBER': 'NUMBER', 'NUMBER0': 'NUMBER0', 'POLYGON_ID': 'POLYGON_ID', 'UNIT_ID': 'UNIT_ID', 'CODE': 'CODE', 'HECTARES': 'HECTARES', 'AREA': 'AREA', 'TYPE_CODE': 'TYPE_CODE', 'DESCRIPT0': 'DESCRIPT0', 'TYPE_COD0': 'TYPE_COD0', 'DESCRIPT1': 'DESCRIPT1', 'Easting': 'Easting', 'Northing': 'Northing', });
...
lyr_Borough_5.set('fieldImages', {'NAME': 'TextEdit', 'AREA_CODE': 'TextEdit', 'DESCRIPTIO': 'TextEdit', 'FILE_NAME': 'TextEdit', 'NUMBER': 'TextEdit', 'NUMBER0': 'TextEdit', 'POLYGON_ID': 'TextEdit', 'UNIT_ID': 'TextEdit', 'CODE': 'TextEdit', 'HECTARES': 'TextEdit', 'AREA': 'TextEdit', 'TYPE_CODE': 'TextEdit', 'DESCRIPT0': 'TextEdit', 'TYPE_COD0': 'TextEdit', 'DESCRIPT1': 'TextEdit', 'Easting': 'TextEdit', 'Northing': 'TextEdit', });
...
lyr_Borough_5.set('fieldLabels', {'NAME': 'no label', 'AREA_CODE': 'no label', 'DESCRIPTIO': 'no label', 'FILE_NAME': 'no label', 'NUMBER': 'no label', 'NUMBER0': 'no label', 'POLYGON_ID': 'no label', 'UNIT_ID': 'no label', 'CODE': 'no label', 'HECTARES': 'no label', 'AREA': 'no label', 'TYPE_CODE': 'no label', 'DESCRIPT0': 'no label', 'TYPE_COD0': 'no label', 'DESCRIPT1': 'no label', 'Easting': 'no label', 'Northing': 'no label', });
lyr_Borough_5.on('precompose', function(evt) {
